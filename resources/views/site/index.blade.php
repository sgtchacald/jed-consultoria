    ...
    <section class="section main-section parallax-scene-js" style="background:url('{{ asset('site/images/bg-1-1700x803.png') }}') no-repeat center center; background-size:cover;">
        <div class="container">
            ...
            <div class="col-xl-8 col-12">
                ...
                <h1 class="text-white text-xl-center wow slideInRight" data-wow-delay=".3s"><span class="align-top offset-top-30 d-inline-block font-weight-light sufix-text"></span><span class="big font-weight-bold d-inline-flex offset-right-170">Consultoria</span></h1>
