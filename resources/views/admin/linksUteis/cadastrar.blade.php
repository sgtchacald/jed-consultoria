...
@section('title', Config::get('label.linksUteis_cadastrar'))
	...
	<div class="row mb-2">
		...
		<div class="col-sm-6">
			<ol class="breadcrumb float-sm-right">
				...
				<li class="breadcrumb-item active">{{Config::get('label.linksUteis_cadastrar')}}</li>
			</ol>
		</div>
	</div>
</div>
...
<div class="card card-primary">
	<div class="card-header">
		<h3 class="card-title">{{Config::get('label.linksUteis_cadastrar')}}</h3>
	</div>

	<form name="formCadastrar" id="formCadastrar" method="post" action="{{route('linksUteis.insert')}}">
    	<div class="card-body">
    			@csrf
				@include('utils.erro')
                    ...
                    <div class="col-sm-6">
						<div class="form-group required">
                            ...
                            <textarea
                                name="url"
                                id="textarea"
                                class="form-control @error('url') is-invalid @enderror tamanhoMaxlenght"
